...
import com.internshala.foodrunner.activity.ForgotPasswordActivity
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        card3 = view.findViewById(R.id.card3) as CardView

        card3.setOnClickListener {
            val intent = Intent(this@HomeFragment.context, SafetyStandardsActivity::class.java)
