...
class DashboardActivity : AppCompatActivity(), DrawerLocker {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*to handle the initialisation of variables*/
        init()

        /*This method is also created to setup the toolbar*/
        setupToolbar()

        /*method to handle the action bar drawer toogle*/
        setupActionBarToggle()

        /*created to display the home fragment inside the activity by default*/
        displayHome()
    ...
    /*separate method to open home fragment.*/
